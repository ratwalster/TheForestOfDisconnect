...
audio_files = [
    ...
    },
    {
        ...
        "voice": "Brian",
        "language": "en-US",
        "ssml": '<speak><prosody rate="1.0" volume="soft">Kai mumbled, Maybe if we knew the path was real.</prosody></speak>',
        "notes": "Soft volume for mumbling, normal rate to show softening."
    },
    {
    ...
    },
    {
        ...
        "voice": "Kendra",
        "language": "en-US",
        "ssml": '<speak><prosody rate="1.1" volume="soft">Mara softened.<break time="0.4s"/> Maybe we could take breaks so Tomas can rest.</prosody></speak>',
        "notes": "Softer tone for resolution, faster rate for Mara’s assertiveness."
    },
    {
        "filename": "audio/chapter3_tomas_2.mp3",
        "voice": "Joey",
        "language": "en-US",
        "ssml": '<speak><prosody rate="0.8" volume="soft">Tomas smiled.<break time="0.3s"/> I’d appreciate that.</prosody></speak>',
        "notes": "Slow rate and soft volume for warmth."
    },
    {
